...
if 'OFF' == 'ON':
    add_lib_to_dll_path('/raid/home/labuseraber/environment/testEnvironment/.conda/lib/libcudnn.so')
    add_lib_to_dll_path('/raid/home/labuseraber/environment/testEnvironment/.conda/lib/libcudart.so')
